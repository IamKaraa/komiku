...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
    ...
    <div class="bg-pink-100 dark:bg-pink-900/50 p-4 rounded-xl shadow-lg flex flex-col items-center justify-center transition-transform transform hover:scale-105">
        ...
        @if($popularComic)
            ...
            <p class="text-lg font-bold text-gray-800 dark:text-white">{{ number_format($popularComic->views_count ?? 0) }}</p>
        @else
            <div class="w-24 h-32 bg-gray-300 dark:bg-gray-600 rounded-md shadow-md flex items-center justify-center">
                <i data-lucide="image" class="w-8 h-8 text-gray-500"></i>
            </div>
            <p class="mt-2 text-base font-semibold text-gray-700 dark:text-gray-300">No Comics Yet</p>
            <p class="text-lg font-bold text-gray-800 dark:text-white">0</p>
        @endif
    </div>
</div>
