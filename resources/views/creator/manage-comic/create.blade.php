...
@section('title', 'Upload Komik Baru')
    ...
    <div class="form-container w-full min-h-screen p-4 md:p-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8 text-center md:text-left">
                <h1 class="text-4xl font-bold text-gray-800">Upload Komik Baru</h1>
                <p class="text-lg text-gray-500 mt-2">Lengkapi informasi komikmu sebelum dipublikasikan.</p>
            </div>

            <!-- Form Card -->
            <div class="form-card p-6 md:p-10">
                <form action="{{ route('creator.comics.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="space-y-8">
                        <!-- Informasi Utama -->
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" name="title" class="form-input"
                                    placeholder="Contoh: Petualangan di Negeri Awan">
                            </div>
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4" class="form-textarea"
                                    placeholder="Ceritakan tentang komikmu secara singkat..."></textarea>
                            </div>
                            <div>
                                ...
                                <div class="custom-dropdown">
                                    <div class="dropdown-button" onclick="toggleDropdown()">
                                        <span id="selected-text">Pilih Genre</span>
                            ...
                            <div>
                                ...
                                <div class="flex space-x-4">
                                    <label class="flex-1">
                                        <input type="radio" name="access_type" value="0" class="sr-only" checked
                                            onclick="togglePriceField()">
                                        <div class="radio-option text-center">Gratis</div>
                                    </label>

                                    <label class="flex-1">
                                        <input type="radio" name="access_type" value="1" class="sr-only"
                                            onclick="togglePriceField()">
                            ...
                            <div id="price-field" class="mt-4 hidden">
                                ...
                                <input type="number" id="price" name="price" class="form-input" placeholder="Contoh: 10000">
                            </div>
                            <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="synopsis" name="synopsis" rows="4" class="form-textarea"
                                    placeholder="Sinopsis lengkap komik..."></textarea>
                            </div>
                            <div>
                        ...
                        <div class="pt-6 border-t">
                            <button type="submit" class="btn-publish">Publikasikan Komik</button>
                        </div>
                    </div>
                </form>
            </div>
